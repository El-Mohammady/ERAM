...
class CustomAccountMoveInherit(models.Model):
  ...
  custom_amount_total = fields.Monetary('Total in Currency' , compute='_compute_custom_amount_total')

  @api.depends('amount_total')
  def _compute_custom_amount_total(self):
    for rec in self:
        rec.custom_amount_total = rec.amount_total
...
class AccountMoveLineInheritCustom(models.Model):
    ...
    the_beneficiary = fields.Char(string="الجهة المستفيدة", required=False, )

...
class SaleOrder(models.Model):
    ...
    def _compute_payments_widget_reconciled_info(self):
        for rec in self:
            move_ids = rec._get_invoice_ids()
            payments_widget_vals = {'title': _('Less Payment'), 'outstanding': False, 'content': [], 'total_amount': rec.tax_totals.get('amount_total')}
            ...
            if payments_widget_vals['content']:
                rec.invoice_payments_widget = payments_widget_vals
            else:
                rec.invoice_payments_widget = False
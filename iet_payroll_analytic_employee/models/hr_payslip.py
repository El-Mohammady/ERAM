...
class HrPayslipInherit(models.Model):
    ...
    employee_analytic = fields.Many2one('employee.analytic.report')
    ...
    def _prepare_slip_lines(self, date, line_ids):
        ...
        for line in self.line_ids.filtered(lambda line: line.category_id):
            ...
            if line.salary_rule_id.employee_analytic:
                for employee in self.employee_id:
                    if debit_account_id:
                        ...
                        debit_line['employee_analytic_id'] = employee.employee_custom_analytic_id.id
                    ...
                    if credit_account_id:
                        ...
                        credit_line['employee_analytic_id'] = employee.employee_custom_analytic_id.id

...
export class AnalyticEmployee extends Component {
    setup(){
        ...
        this.widgetRef = useRef("analyticEmployee");
        ...
        this.openTemplate = useOpenMany2XRecord({
            ...
            fieldString: this.env._t("Analytic Employee Template"),
        });
        this.allPlans = [];
...
//        this.allPlans = await this.orm.call("account.account", "get_relevant_plans", [], argsPlan);
    }
    ...
    async _onSearchMore(searchTerm, editedTag) {
        ...
        this.addDialog(SelectCreateDialog, {
            ...
            resModel: 'account.account',
            context: {
                tree_view_ref: "account.view_account_list",
            },
    ...
    onSaveNew() {
        this.openTemplate({ resId: false, context: {
            'default_analytic_employee': this.listForJson,
        }});
...
AnalyticEmployee.template = "iet_analytic_employee_update.AnalyticEmployee";
AnalyticEmployee.supportedTypes = ["char", "text"];
AnalyticEmployee.components = {
    AutoComplete,
    TagsList,
}

//AnalyticEmployee.fieldDependencies = {
//    analytic_precision: { type: 'integer' },
//}
AnalyticEmployee.props = {
    ...standardFieldProps,
...
AnalyticEmployee.extractProps = ({ field, attrs }) => {
    return {
...
registry.category("fields").add("analytic_employee", AnalyticEmployee);
